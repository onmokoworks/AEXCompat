"""Legacy BCC transitions follow manual progress; not exact AE parity."""
import json
import os
import subprocess
...
PLUGINS = (
    'BCCBlurDissolve.aex',
    'BCCBlurDissolvePrTr.aex',
    'BCCCrashZoomDissolve.aex',
    'BCCCrashZoomDissolvePrTr.aex',
    'BCCCrossGlitch.aex',
    'BCCCrossGlitchPrTr.aex',
    'BCCCrossZoom.aex',
    'BCCCrossZoomPrTr.aex',
    'BCCFastFilmGlowDissolve.aex',
    'BCCFastFilmGlowDissolvePrTr.aex',
    'BCCFilmGlowDissolve.aex',
    'BCCFilmGlowDissolvePrTr.aex',
    'BCCLightLeaksDissolve.aex',
    'BCCLightLeaksDissolvePrTr.aex',
    'BCCPrismDissolve.aex',
    'BCCPrismDissolvePrTr.aex',
    'BCCRGBBlurDissolve.aex',
    'BCCRGBBlurDissolvePrTr.aex',
    'BCCRaysDissolve.aex',
    'BCCRaysDissolvePrTr.aex',
    'BCCRippleDissolve.aex',
    'BCCRippleDissolvePrTr.aex',
    'BCCSpinBlurDissolve.aex',
    'BCCSpinBlurDissolvePrTr.aex',
)


@pytest.mark.parametrize('plugin_name', PLUGINS)
def test_installed_bcc_obsolete_transition_tracks_manual_percent(
