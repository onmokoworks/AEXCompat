"""Legacy BCC wipes follow manual progress; not exact AE parity."""
import json
import os
import subprocess
...
PLUGINS = (
    'BCCLinearWipe.aex',
    'BCCLinearWipePrTr.aex',
    'BCCRadialWipe.aex',
    'BCCRadialWipePrTr.aex',
    'BCCRectangularWipe.aex',
    'BCCRectangularWipePrTr.aex',
    'BCCTexturedWipe.aex',
    'BCCTexturedWipePrTr.aex',
    'BCCVignetteWipe.aex',
    'BCCVignetteWipePrTr.aex',
)


@pytest.mark.parametrize('plugin_name', PLUGINS)
def test_installed_bcc_obsolete_wipe_tracks_manual_percent(tmp_path, plugin_name):
    ...
    assert parameters[3]['choices'] == ['Manual', 'Auto', 'Pct. Done']
    ...
    for percent in (0, 50, 100):
        ...
        assert requested[3] == 3 and requested[4] == percent
