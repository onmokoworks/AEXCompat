...
- `EVIDENCE_POLICY_2026-07-18.md`
  - Shifts the regression axis from frozen-identity re-assertion to
    ...
    admission from frozen regression evidence. Its amendment records that
    compiled worker-trust constants were retired in favor of dispatch-time
    admission.
- `CONFORMANCE_BUNDLE_CONTRACT.md`
  - Defines the manifest/report contract, fail-closed bundle validation,
    one-command runner, and headless/agent-facing CLI contract.
- `MACOS_APPLE_SILICON_PORTING_BOUNDARY_2026-07-22.md`
  - Defines the current Windows boundary and the smallest macOS/Apple Silicon
    investigation slices without claiming platform support.
- `RENDER_SESSION_PROTOCOL_2026-07-19.md`
  - Describes the resident render-session protocol, lifecycle, and current
