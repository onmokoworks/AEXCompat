...
$expectedArtifacts = [ordered]@{
    release_harness = [ordered]@{ path = 'broker/target/release/aexcompat-harness.exe'; size_bytes = 9945600; sha256 = 'bda35050e1505bb7cd1996738d965ebebb4c8f0812518ea13db7c3af129599a8' }
