...
$expectedArtifacts = [ordered]@{
    release_harness = [ordered]@{ path = 'broker/target/release/aexcompat-harness.exe'; size_bytes = 9945600; sha256 = '67e9ac8e731f5a3514e43c85f35095d4a027e00541f2d16a34c679d3213956d4' }
