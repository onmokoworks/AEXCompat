...
$expected = @{
    harness = @{ size = 9868800; sha256 = 'e8be0b6d4251801443b6008ae3e4a36c7a0af33507940789e2567741ed369f3b' }
    worker = @{ size = 797696; sha256 = '9c14c2b653e96807d32fdcb12f80962bc58a4188d9a367e8ba44961533f2f233' }
