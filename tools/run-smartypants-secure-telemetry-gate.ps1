...
$expected = @{
    harness = @{ size = 9945600; sha256 = 'bda35050e1505bb7cd1996738d965ebebb4c8f0812518ea13db7c3af129599a8' }
    worker = @{ size = 845824; sha256 = 'fd69dd640b3ae2ddbe6d8caa595069f9e10a1bd2d9aac2cc8d069bf6b92b33ad' }
