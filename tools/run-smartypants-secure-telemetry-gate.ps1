...
$expected = @{
    harness = @{ size = 9864704; sha256 = '81d48015a2972f4d6446b0eadccad658235fbe04f833a34bfac39541f80b8469' }
    worker = @{ size = 797696; sha256 = '086df3b70d124b5f18c687702b0fbfe0d77d33fc954c10ea6e9e462fc4591ae0' }
