...
// State and catalog records live in worker_aegp_scene_runtime.cpp.  This
// callback fragment intentionally receives aliases below so stale-handle
// validation keeps operating on the one shared scene instance.
