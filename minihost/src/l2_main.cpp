...
auto& g_aegp_command_state = aexcompat::l2_detail::command_state();
auto& g_aegp_keyframe_roundtrip_mode = g_aegp_command_state.keyframe_roundtrip_mode;
auto& g_aegp_seek_roundtrip_mode = g_aegp_command_state.seek_roundtrip_mode;
auto& g_aegp_trim_roundtrip_mode = g_aegp_command_state.trim_roundtrip_mode;
auto& g_aegp_switch_roundtrip_mode = g_aegp_command_state.switch_roundtrip_mode;
bool g_skip_about = false;
auto& g_aegp_commands_created = g_aegp_command_state.commands_created;
auto& g_aegp_menu_commands_inserted = g_aegp_command_state.menu_commands_inserted;
...
auto& g_aegp_command_enable_calls = g_aegp_command_state.command_enable_calls;
auto& g_aegp_command_check_calls = g_aegp_command_state.command_check_calls;
auto& g_aegp_command_checked_true_calls = g_aegp_command_state.command_checked_true_calls;
auto& g_aegp_command_checked_false_calls = g_aegp_command_state.command_checked_false_calls;
...
auto& g_aegp_effect_param_union_calls = g_aegp_command_state.effect_param_union_calls;
...
auto& g_aegp_inserted_commands = g_aegp_command_state.inserted_commands;
