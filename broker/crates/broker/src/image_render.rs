...
const RENDER_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x5a, 0x1c, 0xc8, 0xc8, 0x91, 0x2d, 0x61, 0x43, 0x47, 0x06, 0x43, 0x04, 0x8c, 0x7d, 0xfa,
        0x60, 0x4f, 0x2c, 0x19, 0xd2, 0xb8, 0xe0, 0xce, 0xe7, 0x6f, 0xef, 0x9e, 0xa3, 0xe7, 0xcf,
        0x41, 0x85,
    ],
    expected_size: 783_360,
};
const SMART_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x60, 0x09, 0x49, 0x03, 0x54, 0x4c, 0x2e, 0x15, 0xb6, 0xd2, 0x6b, 0x3b, 0x41, 0xb1, 0xc4,
        0xea, 0x96, 0xb5, 0x65, 0xaf, 0xd5, 0x14, 0xdc, 0x71, 0x67, 0xc9, 0x43, 0xcc, 0xd7, 0x0c,
        0xb4, 0xdd,
    ],
    expected_size: 801_280,
};
