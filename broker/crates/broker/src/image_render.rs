...
const RENDER_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x5c, 0xe5, 0x06, 0xbe, 0xf4, 0xf0, 0xec, 0xff, 0xbc, 0xf5, 0x63, 0x3d, 0x73, 0xc9, 0x9d,
        0xf8, 0x6c, 0x96, 0x22, 0x27, 0x5b, 0xe1, 0x74, 0x9f, 0xbf, 0x2a, 0xde, 0x42, 0xbb, 0x5d,
        0xf2, 0x20,
    ],
    expected_size: 786_944,
};
const SMART_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x62, 0x7b, 0x2a, 0x30, 0x73, 0xc4, 0x1c, 0xc2, 0xb6, 0x98, 0xdb, 0xc4, 0x6f, 0x8e, 0xbc,
        0x14, 0xc1, 0xff, 0x02, 0xb1, 0x89, 0xf0, 0xad, 0xed, 0xd9, 0xe9, 0xfc, 0x69, 0x73, 0xd5,
        0xcf, 0xc8,
    ],
    expected_size: 804_352,
};
