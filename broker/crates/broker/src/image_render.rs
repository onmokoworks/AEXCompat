...
const RENDER_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x2d, 0x03, 0x78, 0x12, 0xb6, 0x15, 0x9b, 0x9c, 0xf0, 0x0b, 0x1b, 0xee, 0xc6, 0x0b, 0x35,
        0x4c, 0x33, 0xba, 0x20, 0x94, 0x2a, 0x58, 0x99, 0xd1, 0xb8, 0x59, 0x41, 0xb6, 0xd4, 0x9f,
        0x87, 0x57,
    ],
    expected_size: 779_776,
};
const SMART_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x18, 0xf8, 0xa5, 0x38, 0x78, 0x6f, 0x56, 0xa5, 0x8e, 0xa1, 0x24, 0x60, 0xde, 0x4e, 0x98,
        0xda, 0x0f, 0x9a, 0x82, 0x48, 0x18, 0xa1, 0xbc, 0xa6, 0x94, 0xf1, 0x4e, 0x9e, 0x77, 0x42,
        0xf5, 0x57,
    ],
    expected_size: 797_184,
};
