...
const RENDER_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x2c, 0xba, 0x31, 0x87, 0x5b, 0x7e, 0x0f, 0x39, 0xff, 0xf8, 0x70, 0xa3, 0xfb, 0xff, 0x4f,
        0xc1, 0x44, 0x42, 0xfe, 0x4d, 0x73, 0x75, 0x5d, 0xbb, 0x9b, 0x1f, 0x9b, 0x6b, 0xe9, 0x6d,
        0x0e, 0x8e,
    ],
    expected_size: 811_008,
};
const SMART_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x66, 0xea, 0xd9, 0x83, 0x9b, 0xa0, 0x25, 0x40, 0xc3, 0x09, 0xb9, 0xff, 0xdd, 0x8c, 0xe0,
        0xa8, 0x98, 0xf9, 0x4e, 0x49, 0xba, 0xf7, 0x5b, 0xf9, 0xa9, 0x0b, 0xe5, 0x5a, 0x6c, 0x6c,
        0xd6, 0x8d,
    ],
    expected_size: 827_904,
};
