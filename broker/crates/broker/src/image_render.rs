...
const RENDER_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x5f, 0x97, 0xc3, 0xd4, 0x1a, 0x7d, 0x91, 0x49, 0xfe, 0xab, 0x14, 0xac, 0x5f, 0x89, 0x2f,
        0x3b, 0xcb, 0x88, 0xa2, 0xd3, 0xd3, 0x8d, 0xd8, 0x69, 0x4f, 0x9b, 0x84, 0xf0, 0xdd, 0xef,
        0xab, 0x47,
    ],
    expected_size: 788_480,
};
const SMART_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0xc5, 0x11, 0xe8, 0x35, 0xf9, 0xe4, 0x76, 0xed, 0xab, 0xed, 0xcf, 0xd3, 0x9b, 0x1e, 0xc6,
        0xf6, 0x6d, 0x39, 0x18, 0x93, 0x57, 0xce, 0x28, 0x01, 0xf0, 0x0c, 0x4c, 0xf8, 0x9a, 0x6b,
        0xb5, 0xf9,
    ],
    expected_size: 805_888,
};
