...
const L2_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x53, 0xa9, 0x28, 0xb4, 0x1f, 0x8d, 0x3e, 0x54, 0x3e, 0xb2, 0x46, 0xaa, 0x62, 0x55, 0xaf,
        0x39, 0x65, 0xa8, 0xf1, 0x45, 0xe0, 0x18, 0x8c, 0xc7, 0x00, 0xd0, 0x5f, 0xa4, 0x00, 0x28,
        0x4c, 0x0a,
    ],
    expected_size: 689_152,
};
const RENDER_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x94, 0xbb, 0xad, 0x9e, 0x15, 0x0e, 0x60, 0x30, 0x60, 0x73, 0xe6, 0x6c, 0x3a, 0xb4, 0xa5,
        0x6d, 0x6c, 0xcf, 0x9b, 0x42, 0xe5, 0x6a, 0xf0, 0x82, 0xdb, 0x90, 0x14, 0xcc, 0x68, 0x3b,
        0x42, 0x54,
    ],
    expected_size: 768_512,
};
const SMART_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x7e, 0x14, 0xda, 0xe3, 0xc4, 0x99, 0x7c, 0x79, 0x4b, 0x7c, 0xcd, 0x24, 0xed, 0x44, 0xc6,
        0x75, 0x4d, 0xef, 0xfc, 0x7f, 0xb8, 0x4c, 0x5d, 0xa2, 0xca, 0xd8, 0x5d, 0x78, 0xe9, 0x3a,
        0xeb, 0x98,
    ],
    expected_size: 787_456,
};
