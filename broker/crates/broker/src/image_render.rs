...
const RENDER_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x31, 0x44, 0x46, 0x06, 0xd2, 0x77, 0x8d, 0x1b, 0xa4, 0x5b, 0xe9, 0x63, 0xfb, 0x30, 0x37,
        0x99, 0x11, 0xce, 0x8c, 0x77, 0xa9, 0x4d, 0x59, 0x83, 0xc7, 0xd1, 0x38, 0x2e, 0x43, 0x59,
        0xb0, 0x6d,
    ],
    expected_size: 784_896,
};
const SMART_WORKER_TRUST: WorkerTrust = WorkerTrust {
    expected_sha256: [
        0x64, 0xb7, 0x4b, 0x25, 0xb5, 0xeb, 0x3a, 0xa9, 0x97, 0xb8, 0x9e, 0xaa, 0x30, 0x92, 0x15,
        0xe0, 0xa4, 0xd5, 0x8f, 0xfc, 0x9a, 0x0a, 0xcf, 0xec, 0xec, 0x0c, 0x39, 0x9a, 0x3a, 0x25,
        0x07, 0xad,
    ],
    expected_size: 802_304,
};
